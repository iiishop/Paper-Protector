...
private:
    ...
    // 内部方法
    void setIRLED(bool state); // 集中控制LED并发布状态
    ...
    static void irledControlCallback(const char *topic, const char *payload);
    static void irledGetCallback(const char *topic, const char *payload);
